        ...
        while True:
            ...
            if len(OUT) > 0:
                ...
                if len(sOut) == 65:
                    ...
                    print finalOut[0]
                    clickedButton=user_input(finalOut[0])
...
def user_input(input):
    clickedButton1 = ''
    if pygame.key.get_pressed()[pygame.K_s] or input==1:
        clickedButton1 = b1
    elif pygame.key.get_pressed()[pygame.K_d] or input==2:
        clickedButton1 = b2
    elif pygame.key.get_pressed()[pygame.K_f] or input==3:
        clickedButton1 = b3
    elif pygame.key.get_pressed()[pygame.K_SPACE] or input==4:
        clickedButton1 = b4
    elif pygame.key.get_pressed()[pygame.K_j] or input==5:
        clickedButton1 = b5
    elif pygame.key.get_pressed()[pygame.K_k] or input==6:
        clickedButton1 = b6
    elif pygame.key.get_pressed()[pygame.K_l] or input==7:
        clickedButton1 = b7
